...
with open(FULL_INFORMATION_FILE, 'rb') as f:
    full_information_dict = pickle.load(f)
    policies = full_information_dict["policies"]
    fairness_index = full_information_dict["fairness_index"]
    cumulative_rewards = full_information_dict["cumulative_rewards"]

    if PLOTREGRET:
        standard_regrets = full_information_dict["standard_regrets"]
        approximate_regrets = full_information_dict["approximate_regrets"]
